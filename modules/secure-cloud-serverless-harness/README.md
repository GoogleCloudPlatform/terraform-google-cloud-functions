...
| cloudfunction\_source\_repository\_id | Cloud Function Source Repository id. |
| cloudfunction\_source\_repository\_name | Cloud Function Source Repository name. |
...
| serverless\_project\_id | Project ID of the project created to deploy Secure Serverless. |
| serverless\_project\_number | Project number of the project created to deploy Secure Serverless. |
| serverless\_service\_identity\_email | The Secure Serverless Service Identity email. |
| service\_account\_email | The email of the Service Account created to be used by Secure Serverless. |
| service\_subnet | The sub-network name created in harness. |
| service\_vpc | The network created for Secure Serverless. |
